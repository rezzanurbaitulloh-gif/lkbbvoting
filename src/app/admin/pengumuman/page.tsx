      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[520px] max-h-[85vh] overflow-y-auto">
          ...
          <div className="grid gap-3">
            ...
            <div><label className="text-xs font-bold">Isi Pengumuman</label><textarea value={form.content} onChange={e=> setForm({...form, content:e.target.value})} placeholder="Tulis isi pengumuman" className="w-full min-h-[80px] rounded-xl border border-white/10 bg-background px-3 py-2 text-sm" /></div>
          </div>
