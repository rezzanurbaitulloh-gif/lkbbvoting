          ...
          <div key={p.id} className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] backdrop-blur p-4 flex flex-col md:flex-row md:items-center justify-between gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {p.is_system && <span className="rounded-full bg-amber-500 text-black px-2 py-0.5 text-[11px] font-bold">Sistem</span>}
                {p.is_published ? <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500 text-black px-2 py-0.5 text-[11px] font-bold"><Eye className="h-3 w-3"/> Publish</span> : <span className="inline-flex items-center gap-1 rounded-full bg-zinc-400 text-black px-2 py-0.5 text-[11px] font-bold"><EyeOff className="h-3 w-3"/> Draft</span>}
