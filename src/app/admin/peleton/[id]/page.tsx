      ...
      <div className="grid lg:grid-cols-[320px_1fr] gap-4">
        ...
        <div className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] backdrop-blur p-5 space-y-3">
          <div className="grid gap-2 text-sm">
            ...
            <div className="flex justify-between"><span className="text-muted-foreground">Status</span><span className={`rounded-full px-2 py-1 text-xs font-bold ${p.status==="Verified"?"bg-emerald-500 text-black":"bg-amber-500 text-black"}`}>{p.status}</span></div>
          </div>
