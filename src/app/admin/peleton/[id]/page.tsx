    ...
    <div className="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-5">
      ...
      <div className="grid lg:grid-cols-[320px_1fr] gap-4">
        ...
        <div className="rounded-[16px] border border-white/10 bg-white/5 backdrop-blur p-5 space-y-3">
          ...
          <div className="rounded-xl bg-white/5 backdrop-blur p-3 text-xs text-muted-foreground">Peleton ini otomatis terverifikasi — tidak perlu aksi verifikasi lagi.</div>
