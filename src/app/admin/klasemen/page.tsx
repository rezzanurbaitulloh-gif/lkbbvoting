      ...
      <div className="mt-3 space-y-1">
        {list.length===0 ? <div className="p-6 text-center text-sm text-muted-foreground">Belum ada ranking.</div> :
          ...
          <div key={p.id} className="flex items-center gap-3 rounded-xl border border-border p-2.5">
            <div className={`h-7 w-7 rounded-full grid place-items-center text-xs font-black shrink-0 ${i===0 ? "bg-[#C9A86A] text-[#0B0C0F]" : i===1 ? "bg-zinc-300 text-black" : i===2 ? "bg-amber-700 text-white" : "bg-muted"}`}>{i+1}</div>
