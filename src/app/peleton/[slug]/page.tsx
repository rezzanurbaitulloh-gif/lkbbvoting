            ...
            <div className="rounded-[16px] border border-border bg-card p-5">
              ...
              <div className="mt-3 space-y-3">
                ...
                <div className="rounded-xl border border-[#C9A86A20] bg-[#C9A86A0A] p-3 text-center">
                  ...
                  <div className="mt-1 inline-flex rounded-full bg-emerald-500 px-3 py-1 text-xs font-bold text-white">{event?.state === "VOTING_OPEN" ? "VOTING BERLANGSUNG" : event?.state}</div>
                </div>
