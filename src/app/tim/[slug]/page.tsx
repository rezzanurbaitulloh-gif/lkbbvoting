  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pb-[72px] md:pb-0">
        <div className="relative border-b border-white/[0.06] overflow-hidden bg-[#09090b] text-white">
          ...
          <div className="relative mx-auto max-w-[1280px] px-3 sm:px-4 md:px-6 py-8 md:py-10">
            <div className="grid lg:grid-cols-[360px_1fr] gap-6 items-end">
              <div className="relative aspect-[4/3] overflow-hidden rounded-[20px] border border-white/10 bg-white/[0.04] backdrop-blur shadow-elevated">
        ...
        <div className="mx-auto max-w-[1280px] px-3 sm:px-4 md:px-6 py-8 grid lg:grid-cols-[1fr_340px] gap-8">
          <div className="space-y-6">
            <section className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] backdrop-blur p-5">
              ...
              <div className="mt-4 grid sm:grid-cols-2 gap-3 text-sm">
                <div className="rounded-xl bg-white/[0.04] backdrop-blur p-3"><div className="label-ceremonial">Sekolah</div><div className="font-semibold">{peleton.school}</div></div>
                <div className="rounded-xl bg-white/[0.04] backdrop-blur p-3"><div className="label-ceremonial">Kota / Provinsi</div><div className="font-semibold">{peleton.city} • {peleton.province}</div></div>
              </div>
            </section>
            ...
            <section className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] backdrop-blur p-5">
              ...
              <div className="mt-3 grid sm:grid-cols-2 gap-3">
                <div className="rounded-xl border border-white/[0.06] p-3 text-sm bg-white/[0.03] backdrop-blur"><div className="font-bold text-foreground">Nomor Peserta</div><div className="text-muted-foreground">#{peleton.number} — nomor urut tampil tim</div></div>
                <div className="rounded-xl border border-white/[0.06] p-3 text-sm bg-white/[0.03] backdrop-blur"><div className="font-bold text-foreground">Kategori</div><div className="text-muted-foreground">{peleton.category} / SEDERAJAT</div></div>
              </div>
          ...
          <div className="flex flex-col gap-4 lg:sticky lg:top-[76px] h-fit">
            <div className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] backdrop-blur p-5 flex flex-col gap-4">
              <h3 className="text-sm font-black">Dukungan</h3>
              <div className="flex flex-col gap-4">
                {showRank && rank ? (
                  <div className="flex items-center justify-between rounded-xl bg-white/[0.04] backdrop-blur p-3 border border-white/[0.06]">
                    <span className="text-sm text-white/70">Peringkat ({peleton.category})</span>
                    <span className="text-sm font-black text-white">#{rank}</span>
                  </div>
                ) : (
                  <div className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-3 text-center backdrop-blur">
                    <div className="text-[11px] font-bold tracking-widest text-amber-300">Klasemen Disembunyikan</div>
                    <p className="text-xs font-medium text-amber-100/90">Ballot disembunyikan selama voting aktif.</p>
                  </div>
                )}
