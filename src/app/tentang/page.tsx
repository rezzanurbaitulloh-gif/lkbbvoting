    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pb-[72px] md:pb-0">
        ...
        <div className="mx-auto max-w-[1080px] px-3 sm:px-4 md:px-6 py-8 space-y-6">
          <div className="rounded-[16px] border border-white/10 bg-white/5 backdrop-blur p-6 grid md:grid-cols-[1.1fr_0.9fr] gap-6 items-center">
            <div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-xl bg-white/5 backdrop-blur p-3"><div className="label-ceremonial">Visi</div><div className="text-sm leading-relaxed">Menjadi wadah kompetisi PBB paling prestisius dan inspiratif di Jawa Timur.</div></div>
                <div className="rounded-xl bg-white/5 backdrop-blur p-3"><div className="label-ceremonial">Misi</div><div className="text-sm leading-relaxed">Membangun disiplin, kekompakan, dan karakter generasi muda melalui PBB.</div></div>
              </div>
            </div>
