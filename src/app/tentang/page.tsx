    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pb-[72px] md:pb-0">
        ...
        <div className="mx-auto max-w-[1080px] px-3 sm:px-4 md:px-6 py-8 space-y-6">
          <div className="rounded-[16px] border border-white/[0.06] bg-white/[0.03] backdrop-blur p-6 grid md:grid-cols-[1.1fr_0.9fr] gap-6 items-center">
            <div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-xl bg-white/[0.04] backdrop-blur p-3"><div className="label-ceremonial">Visi</div><div className="text-sm leading-relaxed">Menjadi wadah kompetisi PBB paling prestisius dan inspiratif di Jawa Timur.</div></div>
                <div className="rounded-xl bg-white/[0.04] backdrop-blur p-3"><div className="label-ceremonial">Misi</div><div className="text-sm leading-relaxed">Membangun disiplin, kekompakan, dan karakter generasi muda melalui PBB.</div></div>
              </div>
            </div>
            <div className="flex gap-3 justify-center">
              <img src="/assets/brand/paskibra-logo.jpg" alt="Paskibra" className="h-36 w-36 sm:h-40 sm:w-40 object-contain bg-transparent" />
              <img src="/assets/brand/school-logo.jpg" alt="SMK" className="h-36 w-36 sm:h-40 sm:w-40 object-contain bg-transparent" />
            </div>
          </div>
