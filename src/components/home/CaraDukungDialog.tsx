...
const steps = [
  ...
  { icon: BadgeCheck, title: "Pembayaran Selesai — Dukungan Masuk!", desc: "Setelah pembayaran terverifikasi, dukungan tercatat otomatis. Notifikasi duar + suara akan muncul ke semua pengguna secara realtime." },
]
