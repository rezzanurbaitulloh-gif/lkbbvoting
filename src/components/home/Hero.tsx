...
export function Hero(){
  const cd = useCountdown(competitionConfig.dates.votingEnd)
  const eventDate = "24 OKTOBER 2026"
  return (
        ...
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-8 py-10 md:py-14 lg:py-16">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-2 rounded-full border border-[#C9A86A30] bg-[#C9A86A14] px-3 py-1 text-[11px] font-bold tracking-[0.14em] text-[#D4B77A]">● LKBB JAVASOMA THE IMPRESSION</span>
              <span className="hidden md:inline-flex text-[11px] tracking-[0.12em] text-white/60 font-semibold">ASTRA DHARMA HAYUNING BUDAYA</span>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-[1.1fr_0.9fr] gap-3">
              <div className="rounded-[16px] border border-white/10 bg-white/[0.06] backdrop-blur p-4">
                <div className="text-center">
                  <div className="label-gold text-white/60">Menuju Perhelatan</div>
              ...
              <div className="rounded-[16px] border border-[#C9A86A20] bg-[#C9A86A0A] backdrop-blur p-4 flex flex-col justify-center">
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                  <div className="rounded-xl bg-[#0B0C0F] border border-white/10 p-2.5 text-center">
                    ...
                    <div className="tabular-nums text-sm font-black text-white">Rp3.000 <span className="text-[10px] font-medium text-white/50">/ ballot</span></div>
                  </div>
                  <div className="rounded-xl bg-[#0B0C0F] border border-white/10 p-2.5 text-center">
                    <div className="text-[10px] font-bold tracking-widest text-white/50">OFFLINE</div>
                    <div className="tabular-nums text-sm font-black text-white">Rp5.000 <span className="text-[10px] font-medium text-white/50">/ ballot</span></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute inset-0 -right-6 -top-6 bottom-0">
              <div className="relative h-full w-full overflow-hidden rounded-[24px] border border-white/10 bg-[#0B0C0F]">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center gap-3 rounded-2xl border border-[#C9A86A30] bg-[#0B0C0F]/80 backdrop-blur p-3">
                  ...
                  <div>
                    <div className="text-sm font-black tracking-tight text-white">LKBB JAVASOMA</div>
                    <div className="text-[11px] tracking-[0.12em] text-[#D4B77A] font-bold">ASTRA DHARMA HAYUNING BUDAYA</div>
                  </div>
