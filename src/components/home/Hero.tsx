        ...
        <div className="pt-8 sm:pt-10 md:pt-14 pb-6 md:pb-8">
          <div className="mx-auto max-w-[720px] text-center flex flex-col items-center px-1">
            ...
            <div className="mt-5 xs:mt-6 flex flex-col xs:flex-row flex-wrap gap-2.5 sm:gap-3 justify-center items-center w-full xs:w-auto px-1 xs:px-0">
              ...
              <Button onClick={()=> setCaraOpen(true)} variant="ghost" size="default" className="w-full xs:w-auto rounded-full px-5 h-[36px] xs:h-[38px] text-xs xs:text-[13px] font-semibold tracking-wide border border-white/10 bg-white/[0.06] backdrop-blur text-white/80 hover:text-white hover:bg-white/10">{ctaSecondaryLabel}</Button>
            </div>
