...
export function Featured({ peletons }: { peletons: any[] }){
  const featured = (peletons || []).slice(0,6)
  return (
    <section className="mx-auto max-w-[1280px] px-4 md:px-6 py-10 md:py-12">
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Kenali dan dukung peleton favoritmu. Urutan sesuai display order resmi.</p>
        </div>
